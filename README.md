...
[![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![365 开源计划 #007](https://img.shields.io/badge/365%20%E5%BC%80%E6%BA%90%E8%AE%A1%E5%88%92-%23007-1f6feb)](https://github.com/rockbenben/365opensource)

**▶ 自托管部署**：`git clone` → `docker compose up -d` → 打开 `http://localhost`（[详细步骤](#快速开始)）
...
部分平台（集思录、淘股吧、同花顺、韭圈儿、有知有行）需要登录才能抓取内容：
...
写适配器插件（三种基类、选择器写法、manifest 格式）和完整项目结构见 **[CONTRIBUTING.md](CONTRIBUTING.md)**。
...
[365 开源计划](https://github.com/rockbenben/365opensource) 的第 **#007** 个项目——一个人 + AI，一年 300+ 个开源项目。[提交你的需求 →](https://365.aishort.top/) · [Discord](https://discord.gg/PZTQfJ4GjX) · [Telegram](https://t.me/aishort_top)
